...
TOOL_ANNOTATIONS = {
    ...
    "upsert_conversation_variable": {
        "title": "Upsert Conversation Variable",
        "readOnlyHint": False,
        "destructiveHint": False,
        "idempotentHint": False,
        "openWorldHint": True,
    ...
    "delete_conversation_variable": {
        "title": "Delete Conversation Variable",
        "readOnlyHint": False,
        "destructiveHint": True,
        "idempotentHint": True,
        "openWorldHint": True,
